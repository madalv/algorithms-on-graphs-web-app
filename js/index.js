...
function graphInit(algo) {
    ...
    svg = d3.select("svg");
    var colors = [d3.scaleOrdinal(d3.schemeCategory10), d3.scaleOrdinal(d3.schemePastel2), d3.scaleOrdinal(d3.schemeDark2),
            d3.scaleOrdinal(d3.schemeSet3), d3.scaleOrdinal(d3.schemeTableau10)
        ],
        width = swidth * 0.8,
